...
## Project Structure
    ...
    ├── testapiautoconnect_117015  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_117015`
...
2. Clone this repo and `cd testapiautoconnect_117015`
